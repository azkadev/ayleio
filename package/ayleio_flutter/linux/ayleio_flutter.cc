...
#include "include/ayleio_flutter/ayleio_flutter.h"

#include <gtk/gtk.h>

#include "include/ayleio_flutter/utils.h"
#include "include/ayleio_flutter/video_output_manager.h"
...
static void
media_kit_video_plugin_handle_method_call(MediaKitVideoPlugin *self,
...
static MediaKitVideoPlugin *
media_kit_video_plugin_new(FlPluginRegistrar *registrar) {
  ...
  self->channel = fl_method_channel_new(
      ...
      "general_developer.library.media_universe/ayleio_flutter", codec);
...
void ayleio_flutter_register_with_registrar(
