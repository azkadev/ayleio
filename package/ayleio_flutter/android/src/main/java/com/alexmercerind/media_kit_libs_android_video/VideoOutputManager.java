...
public class VideoOutputManager {
    ...
    public VideoOutput create(long handle) {
        synchronized (lock) {
            // Log.i("media_kit", String.format(Locale.ENGLISH, "com.alexmercerind.media_kit_libs_android_video_fork.VideoOutputManager.create: %d", handle));
    ...
    public void dispose(long handle) {
        synchronized (lock) {
            // Log.i("media_kit", String.format(Locale.ENGLISH, "com.alexmercerind.media_kit_libs_android_video_fork.VideoOutputManager.dispose: %d", handle));
            if (videoOutputs.containsKey(handle)) {
    ...
    public long createSurface(long handle) {
        synchronized (lock) {
            // Log.i("media_kit", String.format(Locale.ENGLISH, "com.alexmercerind.media_kit_libs_android_video_fork.VideoOutputManager.createSurface: %d", handle));
            if (videoOutputs.containsKey(handle)) {
    ...
    public void setSurfaceTextureSize(long handle, int width, int height) {
        synchronized (lock) {
            // Log.i("media_kit", String.format(Locale.ENGLISH, "com.alexmercerind.media_kit_libs_android_video_fork.VideoOutputManager.setSurfaceTextureSize: %d %d %d", handle, width, height));
            if (videoOutputs.containsKey(handle)) {
