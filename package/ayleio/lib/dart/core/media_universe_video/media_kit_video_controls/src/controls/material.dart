...
// import 'package:media_universe/dart/core/media_universe_video/media_kit_video_fork.dart';
import 'package:volume_controller/volume_controller.dart';
// import 'package:screen_brightness/screen_brightness.dart';
// import 'package:screen_brightness_platform_interface/screen_brightness_platform_interface.dart';

// import 'package:media_universe/dart/core/media_universe_video/media_kit_video_controls/src/controls/methods/video_state.dart';
// import 'package:media_universe/dart/core/media_universe_video/media_kit_video_controls/src/controls/extensions/duration.dart';
// import 'package:media_universe/dart/core/media_universe_video/media_kit_video_controls/src/controls/widgets/video_controls_theme_data_injector.dart';

import 'package:ayleio/dart/core/media_universe_video/media_kit_video_controls/src/controls/methods/video_state.dart';
import 'package:ayleio/dart/core/media_universe_video/media_kit_video_controls/src/controls/extensions/duration.dart';
import 'package:ayleio/dart/core/media_universe_video/media_kit_video_controls/src/controls/widgets/video_controls_theme_data_injector.dart';
// import 'package:media_universe/dart/core/media_universe_video/src/video/video.dart';
...
///
/// {@endtemplate}
Widget MaterialVideoControls(dynamic state) {
...
MaterialVideoControlsThemeData _theme(BuildContext context) => FullscreenInheritedWidget.maybeOf(context) == null ? MaterialVideoControlsTheme.maybeOf(context)?.normal ?? kDefaultMaterialVideoControlsThemeData : MaterialVideoControlsTheme.maybeOf(context)?.fullscreen ?? kDefaultMaterialVideoControlsThemeDataFullscreen;
...
const kDefaultMaterialVideoControlsThemeDataFullscreen = MaterialVideoControlsThemeData(
  ...
  bottomButtonBarMargin: EdgeInsets.only(left: 16.0, right: 8.0, bottom: 42.0),
                  ...
                  Column(
                    children: [
                      ...
                      Stack(
                        alignment: Alignment.bottomCenter,
                        children: [
                          if (_theme(context).displaySeekBar) MaterialSeekBar(delta: _seekBarDeltaValueNotifier),
                          Container(
                            height: _theme(context).buttonBarHeight,
                            margin: _theme(context).bottomButtonBarMargin,
                          ),
                          ...
                          child: _mountSeekBackwardButton
                              ? AnimatedOpacity(
                                  ...
                                  child: _BackwardSeekIndicator(
                                    ...
                                    onSubmitted: (value) {
                                      _timerSeekBackwardButton?.cancel();
                                      _timerSeekBackwardButton = Timer(const Duration(milliseconds: 200), () {
                                        setState(() {
