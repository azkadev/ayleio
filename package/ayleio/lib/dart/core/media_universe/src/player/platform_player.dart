...
abstract class PlatformPlayer {
  ...
  late PlayerStream stream = PlayerStream(
    ...
    logController.stream.distinct((previous, current) => previous == current),
...
class PlayerConfiguration {
  ...
  const PlayerConfiguration({
    ...
    this.osc = false,
    this.pitch = false,
    this.title = 'package:media_kit_fork',
    this.ready,
    this.muted = false,
    this.async = true,
    this.libass = false,
...
enum MPVLogLevel {
  ...
  // package:media_kit_fork internally consumes logs of level error.
