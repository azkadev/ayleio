...
import 'package:ayleio/dart/core/media_universe/ffi/src/allocation.dart';
...
class NativeReferenceHolder {
  ...
  final File _file = File(
    path.join(
      TempFile.directory,
      'general_developer.library.media_universe.media_universe_flutter.NativeReferenceHolder.$pid',
    ),
  );
  ...
  static const String kTag = 'media_kit_fork: NativeReferenceHolder:';
}
