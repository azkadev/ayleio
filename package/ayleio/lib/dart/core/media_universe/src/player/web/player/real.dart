...
import 'package:ayleio/dart/core/media_universe/src/player/web/utils/hls.dart';
import 'package:ayleio/dart/core/media_universe/src/player/web/utils/duration.dart';
    ...
    Future<void> function() async {
      ...
      if (shuffle && _shuffle.isEmpty) {
        ...
        if (_playlist.length > 1) {
          while (const ListEquality().equals(_shuffle, _playlist)) {
            _playlist.shuffle();
          }
        }
